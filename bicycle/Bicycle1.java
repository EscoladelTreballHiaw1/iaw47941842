...
public class Bicycle1 {
     ...
     */
    public Bicycle1(int nFrontSprockets, int nRearSprockets, double v) {
        this.model = "Mountain bike";
     ...
     * @param v The bicycle's speed in km/h.
     */
    public Bicycle1(String model, int frontSprocket, int rearSprocket, int nFrontSprockets, int nRearSprockets, double v) {
        this.model = model;
    ...
    public void accelerate() {
        double newV = this.v + Bicycle1.DV;
        if (newV > Bicycle1.VMAX)
            newV = Bicycle1.VMAX;
        this.v = newV;
    }
    ...
    public void setRearSprocket(int rearSprocket) {
        if (rearSprocket < 0 || rearSprocket > this.nRearSprockets) {
            System.out.printf("pinyó invalid");
        } else {
        this.rearSprocket = rearSprocket;
    }
    }
    ...
    public void setFrontSprocket(int frontSprocket) {
        if (frontSprocket < 0 || frontSprocket > this.nFrontSprockets) {
            System.out.printf("plat invalid");
        } else {
        this.frontSprocket = frontSprocket;
    }
    }
